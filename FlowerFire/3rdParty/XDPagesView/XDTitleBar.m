...
- (void)creatMainUIByBarLayout:(XDTitleBarLayout *)titleBarLayout itleBarRightBtn:(void (^)(void))titleBarRightBtnBlock {
    ...
    _bar = [[UICollectionView alloc]initWithFrame:CGRectMake(OverAllLeft_OR_RightSpace, 0, self.bounds.size.width-rightBtnWidth - 2 * OverAllLeft_OR_RightSpace, self.bounds.size.height) collectionViewLayout:_layout];
   
    _bar.layer.theme_borderColor = THEME_LINE_INPUTBORDERCOLOR;
    _bar.layer.borderWidth = 1;
    _bar.layer.cornerRadius = 5;
