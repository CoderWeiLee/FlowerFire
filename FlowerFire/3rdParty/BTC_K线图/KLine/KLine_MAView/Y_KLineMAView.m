...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _openDescLabel.text = LocalizationKey(@"Open1");
        
        _closeDescLabel = [self private_createLabel];
        _closeDescLabel.text = LocalizationKey(@"Close1");
        
        _highDescLabel = [self private_createLabel];
        _highDescLabel.text = LocalizationKey(@"H");
        
        _lowDescLabel = [self private_createLabel];
        _lowDescLabel.text = LocalizationKey(@"L");
...
{
    if(NSStringFormat(@"%@",model.Date).length != 19){
