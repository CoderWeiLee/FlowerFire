...
//        }
        ...
        UIAlertAction *uac;
        if (photoImg) {
             uac = [UIAlertAction actionWithTitle:LocalizationKey(@"utilTip1") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
                    ...
                    if (success) {
                        [MBManager showBriefAlert:LocalizationKey(@"utilTip2") inView:self];
                    }else{
                        [MBManager showBriefAlert:LocalizationKey(@"utilTip3") inView:self];
                    }
        ...
        UIAlertAction *uac1 = [UIAlertAction actionWithTitle:LocalizationKey(@"Cancel") style:UIAlertActionStyleCancel handler:nil];
        [ua addAction:uac];
        [ua addAction:uac1];
        [[self viewController] presentViewController:ua animated:YES completion:nil];
    }
