...
-(void)showToThemeView:(UIView *)pointView withActions:(NSArray<PopoverAction *> *)actions{
    _isTheme = YES;
    [self showToView:pointView withActions:actions];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.style = _style;
    if(_isTheme){
        [cell themeSetAction:_actions[indexPath.row]];
    }else{
