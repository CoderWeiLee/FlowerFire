...
- (void)viewDidLayoutSubviews
{
    ...
    UIView *titleView = self.gk_navigationItem.titleView;
    UIButton *backButton = self.gk_navigationItem.leftBarButtonItem.customView;
    UIButton *cancelButton = self.gk_navigationItem.rightBarButtonItem.customView;
    ...
    UINavigationBar *navigationBar = self.gk_navigationBar;
...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, Height_NavBar, ScreenWidth, ScreenHeight - Height_NavBar) style:UITableViewStyleGrouped];
...
- (void)setup
{
  ...
  //  backButton.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 0);
    ...
    self.backBarButtonItem = [UIBarButtonItem gk_itemWithImage:[NSBundle py_imageNamed:@"back"] target:self action:@selector(backDidClick)  ] ;
   ...
   //searchBar.backgroundImage = [UIImage imageWithColor:KWhiteColor];//[NSBundle py_imageNamed:@"clearImage"];
    ...
    [self setSearchBarBackgroundColor:KWhiteColor];
    [self setSearchBarCornerRadius:15];
   self.searchBar.layer.cornerRadius = 15;
   self.searchBar.layer.masksToBounds = YES;
   self.searchBar.layer.borderWidth = 0.5;
   self.searchBar.layer.borderColor = rgba(229, 229, 229, 1).CGColor;
...
- (void)setCancelBarButtonItem:(UIBarButtonItem *)cancelBarButtonItem
{
    ...
    self.gk_navigationItem.rightBarButtonItem = cancelBarButtonItem;
}

- (void)setCancelButton:(UIButton *)cancelButton
{
    _cancelButton = cancelButton;
    self.gk_navigationItem.rightBarButtonItem.customView = cancelButton;
}
...
- (void)setSearchViewControllerShowMode:(PYSearchViewControllerShowMode)searchViewControllerShowMode
{
    ...
    if (_searchViewControllerShowMode == PYSearchViewControllerShowModeModal) { // modal
        ...
        self.gk_navigationItem.rightBarButtonItem = _cancelBarButtonItem;
        ...
        self.gk_navigationItem.hidesBackButton = YES;
        self.gk_navigationItem.leftBarButtonItem = _backBarButtonItem;
        self.gk_navigationItem.rightBarButtonItem = nil;
    }
}
