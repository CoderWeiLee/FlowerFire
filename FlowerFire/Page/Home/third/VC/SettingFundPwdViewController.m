//
//  SettingFundPwdViewController.m
//  FlowerFire
//
...
@interface SettingFundPwdViewController ()
{
    NSString *_newPwd;
    NSString *_newPwd2;
...
@implementation SettingFundPwdViewController
...
-(void)submitClick{
    ...
    [self.afnetWork jsonGetDict:@"/api/user/setpaypass" JsonDict:md Tag:@"2"];
}
...
- (void)createNavBar{
    self.gk_navigationItem.title = LocalizationKey(@"578Tip141");
}
...
- (void)textFieldWithText:(UITextField *)textField
{
    ...
    if(_newPwd2.length && _newPwd.length){
